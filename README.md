...
[Claude Code](https://claude.com/claude-code) skills for building **SAP Business One (SAP B1) add-ons** — scaffold a new add-on from a project name, or implement common add-on flows (such as license registration & checking) following an established team pattern.
...
Copy-Item .\skill-for-me\sap-b1-addon-*, .\skill-for-me\smartis-b1-* "$env:USERPROFILE\.claude\skills\" -Recurse
```
